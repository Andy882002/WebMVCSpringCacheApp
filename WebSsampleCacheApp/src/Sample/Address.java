...
/**
 * Cache' Java Class Generated for class Sample.Address on version Cache for Windows (x86-64) 2014.1.2 (Build 753U_SU) Tue Jul 29 2014 11:55:37 EDT.<br>
 * Description: This is a sample embeddable class representing an address.
 *
 * @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address</A>
**/

public class Address extends com.intersys.classes.SerialObject implements java.io.Serializable {
    private static final long serialVersionUID = 7260;
   ...
   */
    ...
    /**
       ...
       @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#City"> City</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#State"> State</A>
    */
    public java.lang.String getState()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("State",false);
       return dh.getString();
    }
    ...
    */
    public void setState(java.lang.String value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("State", dh);
        return;
    }
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#Street"> Street</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#Zip"> Zip</A>
    */
    public java.lang.String getZip()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("Zip",false);
       return dh.getString();
    }
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#%ClassName"> Method %ClassName</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#%Delete"> Method %Delete</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#%DeleteId"> Method %DeleteId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#%IsA"> Method %IsA</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#CityDisplayToLogical"> Method CityDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#CityIsValid"> Method CityIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#CityLogicalToDisplay"> Method CityLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#LogicalToOdbc"> Method LogicalToOdbc</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#OdbcToLogical"> Method OdbcToLogical</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
     ...
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#Populate"> Method Populate</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
    ...
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#PopulateSerial"> Method PopulateSerial</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StateDisplayToLogical"> Method StateDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StateIsValid"> Method StateIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StateLogicalToDisplay"> Method StateLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StreetDisplayToLogical"> Method StreetDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StreetIsValid"> Method StreetIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#StreetLogicalToDisplay"> Method StreetLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#ZipDisplayToLogical"> Method ZipDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#ZipIsValid"> Method ZipIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://VAIO-VGN-FW560F:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Address#ZipLogicalToDisplay"> Method ZipLogicalToDisplay</A>
    */
